...
import {
  doraemonKaomojiFaqContent,
  doraemonKaomojiGroups,
  doraemonKaomojiHeroContent,
  doraemonKaomojiWhatContent,
  doraemonKaomojiWhyContent,
} from "./content";

export default function DoraemonKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...doraemonKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>ドラえもん顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={doraemonKaomojiGroups} />
        <KaomojiWhat {...doraemonKaomojiWhatContent} />
        <KaomojiWhy {...doraemonKaomojiWhyContent} />
        <KaomojiFaq {...doraemonKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/doraemon-kaomoji" />
      </div>
    </div>
  );
}
