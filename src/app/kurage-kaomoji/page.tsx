...
import {
  kurageKaomojiFaqContent,
  kurageKaomojiGroups,
  kurageKaomojiHeroContent,
  kurageKaomojiWhatContent,
  kurageKaomojiWhyContent,
} from "./content";

export default function KurageKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...kurageKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>クラゲ顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={kurageKaomojiGroups} />
        <KaomojiWhat {...kurageKaomojiWhatContent} />
        <KaomojiWhy {...kurageKaomojiWhyContent} />
        <KaomojiFaq {...kurageKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/kurage-kaomoji" />
      </div>
    </div>
  );
}
