...
import {
  catKaomojiFaqContent,
  catKaomojiGroups,
  catKaomojiHeroContent,
  catKaomojiWhatContent,
  catKaomojiWhyContent,
} from "./content";

export default function CatKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...catKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>猫顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={catKaomojiGroups} />
        <KaomojiWhat {...catKaomojiWhatContent} />
        <KaomojiWhy {...catKaomojiWhyContent} />
        <KaomojiFaq {...catKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/cat-kaomoji" />
      </div>
    </div>
  );
}
