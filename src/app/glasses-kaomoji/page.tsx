...
import {
  glassesKaomojiFaqContent,
  glassesKaomojiGroups,
  glassesKaomojiHeroContent,
  glassesKaomojiWhatContent,
  glassesKaomojiWhyContent,
} from "./content";

export default function GlassesKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...glassesKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>メガネ顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={glassesKaomojiGroups} />
        <KaomojiWhat {...glassesKaomojiWhatContent} />
        <KaomojiWhy {...glassesKaomojiWhyContent} />
        <KaomojiFaq {...glassesKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/glasses-kaomoji" />
      </div>
    </div>
  );
}
