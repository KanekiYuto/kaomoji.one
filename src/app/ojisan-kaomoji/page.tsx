...
import {
  ojisanKaomojiFaqContent,
  ojisanKaomojiGroups,
  ojisanKaomojiHeroContent,
  ojisanKaomojiWhatContent,
  ojisanKaomojiWhyContent,
} from "./content";

export default function OjisanKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...ojisanKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>おじさん顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={ojisanKaomojiGroups} />
        <KaomojiWhat {...ojisanKaomojiWhatContent} />
        <KaomojiWhy {...ojisanKaomojiWhyContent} />
        <KaomojiFaq {...ojisanKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/ojisan-kaomoji" />
      </div>
    </div>
  );
}
