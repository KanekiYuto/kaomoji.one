...
import {
  azarashiKaomojiFaqContent,
  azarashiKaomojiGroups,
  azarashiKaomojiHeroContent,
  azarashiKaomojiWhatContent,
  azarashiKaomojiWhyContent,
} from "./content";

export default function AzarashiKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...azarashiKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>あざらし顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={azarashiKaomojiGroups} />
        <KaomojiWhat {...azarashiKaomojiWhatContent} />
        <KaomojiWhy {...azarashiKaomojiWhyContent} />
        <KaomojiFaq {...azarashiKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/azarashi-kaomoji" />
      </div>
    </div>
  );
}
