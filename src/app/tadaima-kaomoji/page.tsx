...
import { tadaimaKaomojiGroups } from "./content";
import {
  tadaimaKaomojiFaqContent,
  tadaimaKaomojiHeroContent,
  tadaimaKaomojiPlainText,
  tadaimaKaomojiWhatContent,
  tadaimaKaomojiWhyContent,
} from "./content";

export default function TadaimaKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...tadaimaKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>ただいま顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={tadaimaKaomojiGroups} />
        ...
        <KaomojiWhat {...tadaimaKaomojiWhatContent} />
        <KaomojiWhy {...tadaimaKaomojiWhyContent} />
        <KaomojiFaq {...tadaimaKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/tadaima-kaomoji" />
      </div>
    </div>
  );
}
