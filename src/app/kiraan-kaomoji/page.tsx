...
import {
  kiraanKaomojiFaqContent,
  kiraanKaomojiGroups,
  kiraanKaomojiHeroContent,
  kiraanKaomojiWhatContent,
  kiraanKaomojiWhyContent,
} from "./content";

export default function KiraanKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...kiraanKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>キラーン顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={kiraanKaomojiGroups} />
        <KaomojiWhat {...kiraanKaomojiWhatContent} />
        <KaomojiWhy {...kiraanKaomojiWhyContent} />
        <KaomojiFaq {...kiraanKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/kiraan-kaomoji" />
      </div>
    </div>
  );
}
