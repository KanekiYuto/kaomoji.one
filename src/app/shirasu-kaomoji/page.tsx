...
import {
  shirasuKaomojiFaqContent,
  shirasuKaomojiGroups,
  shirasuKaomojiHeroContent,
  shirasuKaomojiWhatContent,
  shirasuKaomojiWhyContent,
} from "./content";

export default function ShirasuKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...shirasuKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>しらす顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={shirasuKaomojiGroups} />
        <KaomojiWhat {...shirasuKaomojiWhatContent} />
        <KaomojiWhy {...shirasuKaomojiWhyContent} />
        <KaomojiFaq {...shirasuKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/shirasu-kaomoji" />
      </div>
    </div>
  );
}
