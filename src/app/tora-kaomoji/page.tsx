...
import {
  toraKaomojiFaqContent,
  toraKaomojiGroups,
  toraKaomojiHeroContent,
  toraKaomojiWhatContent,
  toraKaomojiWhyContent,
} from "./content";

export default function ToraKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...toraKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>虎顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={toraKaomojiGroups} />
        <KaomojiWhat {...toraKaomojiWhatContent} />
        <KaomojiWhy {...toraKaomojiWhyContent} />
        <KaomojiFaq {...toraKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/tora-kaomoji" />
      </div>
    </div>
  );
}
