...
import { okaeriKaomojiGroups } from "./content";
import {
  okaeriKaomojiFaqContent,
  okaeriKaomojiHeroContent,
  okaeriKaomojiPlainText,
  okaeriKaomojiWhatContent,
  okaeriKaomojiWhyContent,
} from "./content";

export default function OkaeriKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...okaeriKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>おかえり顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={okaeriKaomojiGroups} />
        ...
        <KaomojiWhat {...okaeriKaomojiWhatContent} />
        <KaomojiWhy {...okaeriKaomojiWhyContent} />
        <KaomojiFaq {...okaeriKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/okaeri-kaomoji" />
      </div>
    </div>
  );
}
