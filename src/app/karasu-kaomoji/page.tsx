...
import {
  karasuKaomojiFaqContent,
  karasuKaomojiGroups,
  karasuKaomojiHeroContent,
  karasuKaomojiWhatContent,
  karasuKaomojiWhyContent,
} from "./content";

export default function KarasuKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...karasuKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>カラス顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={karasuKaomojiGroups} />
        <KaomojiWhat {...karasuKaomojiWhatContent} />
        <KaomojiWhy {...karasuKaomojiWhyContent} />
        <KaomojiFaq {...karasuKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/karasu-kaomoji" />
      </div>
    </div>
  );
}
