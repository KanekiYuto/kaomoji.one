...
import {
  jiraiKaomojiFaqContent,
  jiraiKaomojiGroups,
  jiraiKaomojiHeroContent,
  jiraiKaomojiWhatContent,
  jiraiKaomojiWhyContent,
} from "./content";

export default function JiraiKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...jiraiKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>地雷系顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={jiraiKaomojiGroups} />
        <KaomojiWhat {...jiraiKaomojiWhatContent} />
        <KaomojiWhy {...jiraiKaomojiWhyContent} />
        <KaomojiFaq {...jiraiKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/jirai-kaomoji" />
      </div>
    </div>
  );
}
