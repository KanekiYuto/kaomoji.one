...
import {
  homooKaomojiFaqContent,
  homooKaomojiGroups,
  homooKaomojiHeroContent,
  homooKaomojiWhatContent,
  homooKaomojiWhyContent,
} from "./content";

export default function HomooKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...homooKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>ホモォ顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={homooKaomojiGroups} />
        <KaomojiWhat {...homooKaomojiWhatContent} />
        <KaomojiWhy {...homooKaomojiWhyContent} />
        <KaomojiFaq {...homooKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/homoo-kaomoji" />
      </div>
    </div>
  );
}
