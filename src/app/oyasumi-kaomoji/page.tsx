...
import { oyasumiKaomojiGroups } from "./content";
import {
  oyasumiKaomojiFaqContent,
  oyasumiKaomojiHeroContent,
  oyasumiKaomojiPlainText,
  oyasumiKaomojiWhatContent,
  oyasumiKaomojiWhyContent,
} from "./content";

export default function OyasumiKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...oyasumiKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>おやすみ顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={oyasumiKaomojiGroups} />
        ...
        <KaomojiWhat {...oyasumiKaomojiWhatContent} />
        <KaomojiWhy {...oyasumiKaomojiWhyContent} />
        <KaomojiFaq {...oyasumiKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/oyasumi-kaomoji" />
      </div>
    </div>
  );
}
