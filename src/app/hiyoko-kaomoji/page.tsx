...
import {
  hiyokoKaomojiFaqContent,
  hiyokoKaomojiGroups,
  hiyokoKaomojiHeroContent,
  hiyokoKaomojiWhatContent,
  hiyokoKaomojiWhyContent,
} from "./content";

export default function HiyokoKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...hiyokoKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>ひよこ顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={hiyokoKaomojiGroups} />
        <KaomojiWhat {...hiyokoKaomojiWhatContent} />
        <KaomojiWhy {...hiyokoKaomojiWhyContent} />
        <KaomojiFaq {...hiyokoKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/hiyoko-kaomoji" />
      </div>
    </div>
  );
}
