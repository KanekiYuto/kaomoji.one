...
import {
  kirakiraKaomojiFaqContent,
  kirakiraKaomojiGroups,
  kirakiraKaomojiHeroContent,
  kirakiraKaomojiWhatContent,
  kirakiraKaomojiWhyContent,
} from "./content";

export default function KirakiraKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...kirakiraKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>キラキラ/キラッ☆/キラーン顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={kirakiraKaomojiGroups} />
        <KaomojiWhat {...kirakiraKaomojiWhatContent} />
        <KaomojiWhy {...kirakiraKaomojiWhyContent} />
        <KaomojiFaq {...kirakiraKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/kirakira-kaomoji" />
      </div>
    </div>
  );
}
