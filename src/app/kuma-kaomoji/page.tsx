...
import {
  kumaKaomojiFaqContent,
  kumaKaomojiGroups,
  kumaKaomojiHeroContent,
  kumaKaomojiWhatContent,
  kumaKaomojiWhyContent,
} from "./content";

export default function KumaKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...kumaKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>くま顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={kumaKaomojiGroups} />
        <KaomojiWhat {...kumaKaomojiWhatContent} />
        <KaomojiWhy {...kumaKaomojiWhyContent} />
        <KaomojiFaq {...kumaKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/kuma-kaomoji" />
      </div>
    </div>
  );
}
