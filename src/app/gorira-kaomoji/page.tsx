...
import {
  goriraKaomojiFaqContent,
  goriraKaomojiGroups,
  goriraKaomojiHeroContent,
  goriraKaomojiWhatContent,
  goriraKaomojiWhyContent,
} from "./content";

export default function GoriraKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...goriraKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>ゴリラ顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={goriraKaomojiGroups} />
        <KaomojiWhat {...goriraKaomojiWhatContent} />
        <KaomojiWhy {...goriraKaomojiWhyContent} />
        <KaomojiFaq {...goriraKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/gorira-kaomoji" />
      </div>
    </div>
  );
}
