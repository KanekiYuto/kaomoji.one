...
import { aisatsuKaomojiGroups } from "./content";
import {
  aisatsuKaomojiFaqContent,
  aisatsuKaomojiHeroContent,
  aisatsuKaomojiPlainText,
  aisatsuKaomojiWhatContent,
  aisatsuKaomojiWhyContent,
} from "./content";

export default function AisatsuKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...aisatsuKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>挨拶顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={aisatsuKaomojiGroups} />
        ...
        <KaomojiWhat {...aisatsuKaomojiWhatContent} />
        <KaomojiWhy {...aisatsuKaomojiWhyContent} />
        <KaomojiFaq {...aisatsuKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/aisatsu-kaomoji" />
      </div>
    </div>
  );
}
