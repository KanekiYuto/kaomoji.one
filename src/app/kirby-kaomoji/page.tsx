...
import {
  kirbyKaomojiFaqContent,
  kirbyKaomojiGroups,
  kirbyKaomojiHeroContent,
  kirbyKaomojiWhatContent,
  kirbyKaomojiWhyContent,
} from "./content";

export default function KirbyKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...kirbyKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>カービィ顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={kirbyKaomojiGroups} />
        <KaomojiWhat {...kirbyKaomojiWhatContent} />
        <KaomojiWhy {...kirbyKaomojiWhyContent} />
        <KaomojiFaq {...kirbyKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/kirby-kaomoji" />
      </div>
    </div>
  );
}
