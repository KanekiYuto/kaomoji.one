...
import {
  gyaruKaomojiFaqContent,
  gyaruKaomojiGroups,
  gyaruKaomojiHeroContent,
  gyaruKaomojiWhatContent,
  gyaruKaomojiWhyContent,
} from "./content";

export default function GyaruKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...gyaruKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>ギャル顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={gyaruKaomojiGroups} />
        <KaomojiWhat {...gyaruKaomojiWhatContent} />
        <KaomojiWhy {...gyaruKaomojiWhyContent} />
        <KaomojiFaq {...gyaruKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/gyaru-kaomoji" />
      </div>
    </div>
  );
}
