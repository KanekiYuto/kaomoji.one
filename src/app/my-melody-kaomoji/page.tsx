...
import {
  myMelodyKaomojiFaqContent,
  myMelodyKaomojiGroups,
  myMelodyKaomojiHeroContent,
  myMelodyKaomojiWhatContent,
  myMelodyKaomojiWhyContent,
} from "./content";

export default function MyMelodyKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...myMelodyKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>マイメロ顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={myMelodyKaomojiGroups} />
        <KaomojiWhat {...myMelodyKaomojiWhatContent} />
        <KaomojiWhy {...myMelodyKaomojiWhyContent} />
        <KaomojiFaq {...myMelodyKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/my-melody-kaomoji" />
      </div>
    </div>
  );
}
