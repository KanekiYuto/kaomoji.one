...
import { ohayouKaomojiGroups } from "./content";
import {
  ohayouKaomojiFaqContent,
  ohayouKaomojiHeroContent,
  ohayouKaomojiPlainText,
  ohayouKaomojiWhatContent,
  ohayouKaomojiWhyContent,
} from "./content";

export default function OhayouKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...ohayouKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>おはよう顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={ohayouKaomojiGroups} />
        ...
        <KaomojiWhat {...ohayouKaomojiWhatContent} />
        <KaomojiWhy {...ohayouKaomojiWhyContent} />
        <KaomojiFaq {...ohayouKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/ohayou-kaomoji" />
      </div>
    </div>
  );
}
