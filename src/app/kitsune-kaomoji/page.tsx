...
import {
  kitsuneKaomojiFaqContent,
  kitsuneKaomojiGroups,
  kitsuneKaomojiHeroContent,
  kitsuneKaomojiWhatContent,
  kitsuneKaomojiWhyContent,
} from "./content";

export default function KitsuneKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...kitsuneKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>きつね顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={kitsuneKaomojiGroups} />
        <KaomojiWhat {...kitsuneKaomojiWhatContent} />
        <KaomojiWhy {...kitsuneKaomojiWhyContent} />
        <KaomojiFaq {...kitsuneKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/kitsune-kaomoji" />
      </div>
    </div>
  );
}
