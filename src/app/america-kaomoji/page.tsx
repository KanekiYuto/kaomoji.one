...
import {
  americaKaomojiFaqContent,
  americaKaomojiGroups,
  americaKaomojiHeroContent,
  americaKaomojiWhatContent,
  americaKaomojiWhyContent,
} from "./content";

export default function AmericaKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...americaKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>アメリカ顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={americaKaomojiGroups} />
        <KaomojiWhat {...americaKaomojiWhatContent} />
        <KaomojiWhy {...americaKaomojiWhyContent} />
        <KaomojiFaq {...americaKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/america-kaomoji" />
      </div>
    </div>
  );
}
