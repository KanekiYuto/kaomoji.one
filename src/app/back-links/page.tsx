...
import { BACK_LINK_URLS, BACK_LINKS_LAST_UPDATED } from "@/features/back-links/data/back-links";
import { withCanonical } from "@/lib/seo";

export const metadata: Metadata = {
  title: "バックリンク｜被リンク（反向リンク）一覧",
  description:
    "用于记录与本站相关的反向链接（Backlinks/被リンク）列表，帮助搜索引擎更快发现与收录。",
    ...
    <div className="mx-auto max-w-6xl px-4 py-12 md:px-6">
      <div className="space-y-3">
        ...
        <p className="text-sm leading-relaxed text-muted-foreground md:text-base">
          反向链接（Backlinks）/ 友链の一覧ページ。更新日：{BACK_LINKS_LAST_UPDATED}
        </p>
        <p className="text-sm leading-relaxed text-muted-foreground md:text-base">
