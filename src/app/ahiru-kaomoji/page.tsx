...
import {
  ahiruKaomojiFaqContent,
  ahiruKaomojiGroups,
  ahiruKaomojiHeroContent,
  ahiruKaomojiWhatContent,
  ahiruKaomojiWhyContent,
} from "./content";

export default function AhiruKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...ahiruKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>アヒル顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={ahiruKaomojiGroups} />
        <KaomojiWhat {...ahiruKaomojiWhatContent} />
        <KaomojiWhy {...ahiruKaomojiWhyContent} />
        <KaomojiFaq {...ahiruKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/ahiru-kaomoji" />
      </div>
    </div>
  );
}
