...
import {
  nyaaKaomojiFaqContent,
  nyaaKaomojiGroups,
  nyaaKaomojiHeroContent,
  nyaaKaomojiWhatContent,
  nyaaKaomojiWhyContent,
} from "./content";

export default function NyaaKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...nyaaKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>にゃー顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={nyaaKaomojiGroups} />
        <KaomojiWhat {...nyaaKaomojiWhatContent} />
        <KaomojiWhy {...nyaaKaomojiWhyContent} />
        <KaomojiFaq {...nyaaKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/nyaa-kaomoji" />
      </div>
    </div>
  );
}
