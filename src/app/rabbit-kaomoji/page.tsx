...
import {
  rabbitKaomojiFaqContent,
  rabbitKaomojiGroups,
  rabbitKaomojiHeroContent,
  rabbitKaomojiWhatContent,
  rabbitKaomojiWhyContent,
} from "./content";

export default function RabbitKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...rabbitKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>うさぎ/ウサギ/兎顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={rabbitKaomojiGroups} />
        <KaomojiWhat {...rabbitKaomojiWhatContent} />
        <KaomojiWhy {...rabbitKaomojiWhyContent} />
        <KaomojiFaq {...rabbitKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/rabbit-kaomoji" />
      </div>
    </div>
  );
}
