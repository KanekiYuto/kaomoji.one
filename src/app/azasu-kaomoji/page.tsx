...
import {
  azasuKaomojiFaqContent,
  azasuKaomojiGroups,
  azasuKaomojiHeroContent,
  azasuKaomojiWhatContent,
  azasuKaomojiWhyContent,
} from "./content";

export default function AzasuKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...azasuKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>あざーす/あざす/アザース顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={azasuKaomojiGroups} />
        <KaomojiWhat {...azasuKaomojiWhatContent} />
        <KaomojiWhy {...azasuKaomojiWhyContent} />
        <KaomojiFaq {...azasuKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/azasu-kaomoji" />
      </div>
    </div>
  );
}
