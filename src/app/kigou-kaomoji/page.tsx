...
import {
  kigouKaomojiFaqContent,
  kigouKaomojiGroups,
  kigouKaomojiHeroContent,
  kigouKaomojiWhatContent,
  kigouKaomojiWhyContent,
} from "./content";

export default function KigouKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...kigouKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>記号顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={kigouKaomojiGroups} />
        <KaomojiWhat {...kigouKaomojiWhatContent} />
        <KaomojiWhy {...kigouKaomojiWhyContent} />
        <KaomojiFaq {...kigouKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/kigou-kaomoji" />
      </div>
    </div>
  );
}
