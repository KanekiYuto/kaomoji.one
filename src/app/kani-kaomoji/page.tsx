...
import {
  kaniKaomojiFaqContent,
  kaniKaomojiGroups,
  kaniKaomojiHeroContent,
  kaniKaomojiWhatContent,
  kaniKaomojiWhyContent,
} from "./content";

export default function KaniKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...kaniKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>カニ顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={kaniKaomojiGroups} />
        <KaomojiWhat {...kaniKaomojiWhatContent} />
        <KaomojiWhy {...kaniKaomojiWhyContent} />
        <KaomojiFaq {...kaniKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/kani-kaomoji" />
      </div>
    </div>
  );
}
