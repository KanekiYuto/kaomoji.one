...
import {
  takoKaomojiFaqContent,
  takoKaomojiGroups,
  takoKaomojiHeroContent,
  takoKaomojiWhatContent,
  takoKaomojiWhyContent,
} from "./content";

export default function TakoKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...takoKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>たこ顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={takoKaomojiGroups} />
        <KaomojiWhat {...takoKaomojiWhatContent} />
        <KaomojiWhy {...takoKaomojiWhyContent} />
        <KaomojiFaq {...takoKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/tako-kaomoji" />
      </div>
    </div>
  );
}
