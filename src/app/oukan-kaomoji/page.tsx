...
import {
  oukanKaomojiFaqContent,
  oukanKaomojiGroups,
  oukanKaomojiHeroContent,
  oukanKaomojiWhatContent,
  oukanKaomojiWhyContent,
} from "./content";

export default function OukanKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...oukanKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>王冠顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={oukanKaomojiGroups} />
        <KaomojiWhat {...oukanKaomojiWhatContent} />
        <KaomojiWhy {...oukanKaomojiWhyContent} />
        <KaomojiFaq {...oukanKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/oukan-kaomoji" />
      </div>
    </div>
  );
}
