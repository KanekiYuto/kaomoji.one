...
import {
  takoyakiKaomojiFaqContent,
  takoyakiKaomojiGroups,
  takoyakiKaomojiHeroContent,
  takoyakiKaomojiWhatContent,
  takoyakiKaomojiWhyContent,
} from "./content";

export default function TakoyakiKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...takoyakiKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>たこ焼き顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={takoyakiKaomojiGroups} />
        <KaomojiWhat {...takoyakiKaomojiWhatContent} />
        <KaomojiWhy {...takoyakiKaomojiWhyContent} />
        <KaomojiFaq {...takoyakiKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/takoyaki-kaomoji" />
      </div>
    </div>
  );
}
