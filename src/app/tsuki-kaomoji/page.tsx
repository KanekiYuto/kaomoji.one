...
import {
  tsukiKaomojiFaqContent,
  tsukiKaomojiGroups,
  tsukiKaomojiHeroContent,
  tsukiKaomojiWhatContent,
  tsukiKaomojiWhyContent,
} from "./content";

export default function TsukiKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...tsukiKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>月顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={tsukiKaomojiGroups} />
        <KaomojiWhat {...tsukiKaomojiWhatContent} />
        <KaomojiWhy {...tsukiKaomojiWhyContent} />
        <KaomojiFaq {...tsukiKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/tsuki-kaomoji" />
      </div>
    </div>
  );
}
