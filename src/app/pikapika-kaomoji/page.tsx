...
import {
  pikapikaKaomojiFaqContent,
  pikapikaKaomojiGroups,
  pikapikaKaomojiHeroContent,
  pikapikaKaomojiWhatContent,
  pikapikaKaomojiWhyContent,
} from "./content";

export default function PikapikaKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...pikapikaKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>ピカピカ顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={pikapikaKaomojiGroups} />
        <KaomojiWhat {...pikapikaKaomojiWhatContent} />
        <KaomojiWhy {...pikapikaKaomojiWhyContent} />
        <KaomojiFaq {...pikapikaKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/pikapika-kaomoji" />
      </div>
    </div>
  );
}
