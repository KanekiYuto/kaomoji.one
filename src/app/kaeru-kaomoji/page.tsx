...
import {
  kaeruKaomojiFaqContent,
  kaeruKaomojiGroups,
  kaeruKaomojiHeroContent,
  kaeruKaomojiWhatContent,
  kaeruKaomojiWhyContent,
} from "./content";

export default function KaeruKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...kaeruKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>カエル顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={kaeruKaomojiGroups} />
        <KaomojiWhat {...kaeruKaomojiWhatContent} />
        <KaomojiWhy {...kaeruKaomojiWhyContent} />
        <KaomojiFaq {...kaeruKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/kaeru-kaomoji" />
      </div>
    </div>
  );
}
