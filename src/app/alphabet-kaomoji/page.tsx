...
import {
  alphabetKaomojiFaqContent,
  alphabetKaomojiGroups,
  alphabetKaomojiHeroContent,
  alphabetKaomojiWhatContent,
  alphabetKaomojiWhyContent,
} from "./content";

export default function AlphabetKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...alphabetKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>アルファベット顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={alphabetKaomojiGroups} />
        <KaomojiWhat {...alphabetKaomojiWhatContent} />
        <KaomojiWhy {...alphabetKaomojiWhyContent} />
        <KaomojiFaq {...alphabetKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/alphabet-kaomoji" />
      </div>
    </div>
  );
}
