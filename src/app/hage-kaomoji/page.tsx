...
import {
  hageKaomojiFaqContent,
  hageKaomojiGroups,
  hageKaomojiHeroContent,
  hageKaomojiWhatContent,
  hageKaomojiWhyContent,
} from "./content";

export default function HageKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...hageKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>ハゲ顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={hageKaomojiGroups} />
        <KaomojiWhat {...hageKaomojiWhatContent} />
        <KaomojiWhy {...hageKaomojiWhyContent} />
        <KaomojiFaq {...hageKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/hage-kaomoji" />
      </div>
    </div>
  );
}
