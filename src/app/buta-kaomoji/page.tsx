...
import {
  butaKaomojiFaqContent,
  butaKaomojiGroups,
  butaKaomojiHeroContent,
  butaKaomojiWhatContent,
  butaKaomojiWhyContent,
} from "./content";

export default function ButaKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...butaKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>豚顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={butaKaomojiGroups} />
        <KaomojiWhat {...butaKaomojiWhatContent} />
        <KaomojiWhy {...butaKaomojiWhyContent} />
        <KaomojiFaq {...butaKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/buta-kaomoji" />
      </div>
    </div>
  );
}
