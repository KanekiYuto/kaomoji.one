...
import {
  shisaKaomojiFaqContent,
  shisaKaomojiGroups,
  shisaKaomojiHeroContent,
  shisaKaomojiWhatContent,
  shisaKaomojiWhyContent,
} from "./content";

export default function ShisaKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...shisaKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>シーサー顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={shisaKaomojiGroups} />
        <KaomojiWhat {...shisaKaomojiWhatContent} />
        <KaomojiWhy {...shisaKaomojiWhyContent} />
        <KaomojiFaq {...shisaKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/shisa-kaomoji" />
      </div>
    </div>
  );
}
