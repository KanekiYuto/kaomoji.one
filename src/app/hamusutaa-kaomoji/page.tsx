...
import {
  hamusutaaKaomojiFaqContent,
  hamusutaaKaomojiGroups,
  hamusutaaKaomojiHeroContent,
  hamusutaaKaomojiWhatContent,
  hamusutaaKaomojiWhyContent,
} from "./content";

export default function HamusutaaKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...hamusutaaKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>ハムスター顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={hamusutaaKaomojiGroups} />
        <KaomojiWhat {...hamusutaaKaomojiWhatContent} />
        <KaomojiWhy {...hamusutaaKaomojiWhyContent} />
        <KaomojiFaq {...hamusutaaKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/hamusutaa-kaomoji" />
      </div>
    </div>
  );
}
