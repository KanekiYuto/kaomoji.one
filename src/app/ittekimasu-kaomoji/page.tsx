...
import { ittekimasuKaomojiGroups } from "./content";
import {
  ittekimasuKaomojiFaqContent,
  ittekimasuKaomojiHeroContent,
  ittekimasuKaomojiPlainText,
  ittekimasuKaomojiWhatContent,
  ittekimasuKaomojiWhyContent,
} from "./content";

export default function IttekimasuKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...ittekimasuKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>行ってきます顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={ittekimasuKaomojiGroups} />
        ...
        <KaomojiWhat {...ittekimasuKaomojiWhatContent} />
        <KaomojiWhy {...ittekimasuKaomojiWhyContent} />
        <KaomojiFaq {...ittekimasuKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/ittekimasu-kaomoji" />
      </div>
    </div>
  );
}
