...
import {
  menheraKaomojiFaqContent,
  menheraKaomojiGroups,
  menheraKaomojiHeroContent,
  menheraKaomojiWhatContent,
  menheraKaomojiWhyContent,
} from "./content";

export default function MenheraKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...menheraKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>メンヘラ顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={menheraKaomojiGroups} />
        <KaomojiWhat {...menheraKaomojiWhatContent} />
        <KaomojiWhy {...menheraKaomojiWhyContent} />
        <KaomojiFaq {...menheraKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/menhera-kaomoji" />
      </div>
    </div>
  );
}
