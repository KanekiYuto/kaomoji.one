...
import {
  lineKaomojiFaqContent,
  lineKaomojiGroups,
  lineKaomojiHeroContent,
  lineKaomojiWhatContent,
  lineKaomojiWhyContent,
} from "./content";

export default function LineKaomojiPage() {
  return (
    <div>
      <KaomojiHero {...lineKaomojiHeroContent} />
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>線/ライン顔文字</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <KaomojiExplorer groups={lineKaomojiGroups} />
        <KaomojiWhat {...lineKaomojiWhatContent} />
        <KaomojiWhy {...lineKaomojiWhyContent} />
        <KaomojiFaq {...lineKaomojiFaqContent} />
        <RecommendedKaomojiSection currentPath="/line-kaomoji" />
      </div>
    </div>
  );
}
